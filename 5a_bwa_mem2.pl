...
my $bwa_mem2 = "/uufs/chpc.utah.edu/sys/installdir/r8/bwa-mem/2.2.1/bwa-mem2";  
# replace this with $(which bwa-mem2 mem) after loading the module from my home directory
